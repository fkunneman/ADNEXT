...
parser.add_argument('--id', action='store',required = True, help = "specify the index of the id in metafiles")
parser.add_argument('--id', action='store',required = True, help = "specify the index of the instance label in metafiles")
